...
function createtime1() {
  var grt = new Date("18/07/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Char🍨 %c 你正在访问Char🍨の小家",
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(img/bg/webp/bg1.webp);
    --darkmode-bg:url(img/bg/webp/bg2.webp);
    --mobileday-bg: url(img/bg/webp/bg1.webp);
    --mobilenight-bg: url(img/bg/webp/bg2.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<p id="swfs">
<a class="swf" id="swf_HYTRW" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYTRW'!important;color:black" onclick="setFont('HYTRW')">HYTangMeiRen55W</a>
<a class="swf" id="XLWK" href="javascript:;" rel="noopener external nofollow" style="font-family:'XLWK'!important;color:black" onclick="setFont('XLWK')">霞鹜文楷</a>
<a class="swf" id="LXXX" href="javascript:;" rel="noopener external nofollow" style="font-family:'LXXX'!important;color:black" onclick="setFont('LXXX')">联想小新潮酷体</a>
<a class="swf" id="swf_default" href="javascript:;" rel="noopener external nofollow" style="font-family:'default'!important;color:black" onclick="setFont('default')">系统默认</a>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(/img/bg/webp/bg1.webp)" class="imgbox" onclick="changeBg('url(/img/bg/webp/bg1.webp)')"></a></div>
              </div>
            </details>
